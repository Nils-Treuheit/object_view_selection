...
REASON_LABELS = {
    ...
    "vincents_motion_blur": "motion blur (smeared boundary)",
    "vincents_motion_blur_threshold": "motion blur (below minimum sharpness)",
    "vincents_motion_blur_outlier": "motion blur (extreme outlier)",
