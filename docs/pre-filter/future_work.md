...
## `OcclusionFilter` (`preprocessing/future_work/occlusion_filter.py`)
...
## `ConfidenceFilter` (`preprocessing/future_work/confidence.py`)
...
## `CompletenessFilter` (`preprocessing/future_work/completeness_filter.py`)
